...
export const PLANS: Record<PlanId, Plan> = {
  standard: {
    ...
    price: "499 €",
    period: "/ mois",
    tagline: "Conçu pour les petites entreprises qui intègrent leur premier employé IA.",
    unlock:
    ...
    limits: [
      ...
      "Aucun travail collaboratif entre agents",
      "Pas d'accès aux modèles IA premium",
    ],
  },
  ...
  professionnel: {
    ...
    price: "1 999 €",
    period: "/ mois",
    tagline: "Pour les entreprises qui construisent une véritable équipe d'employés IA.",
    unlock:
  ...
  entreprise: {
    ...
    price: "9 999 €",
    period: "/ mois",
    tagline: "Pour les entreprises qui automatisent des départements entiers.",
    unlock:
      "Des équipes d'agents qui s'organisent, se supervisent et s'améliorent elles-mêmes — à l'échelle d'une organisation entière.",
    highlights: [
      "Employés IA illimités",
      "Équipes d'agents autonomes",
      "Superviseur IA",
